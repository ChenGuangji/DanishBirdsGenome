...
# 读取数据
data = read_excel("Plot_20250911.xlsx") 
data_filter <- data %>% filter(Note=="Paper & Website")
data_filter$`Construct library technology`[data_filter$`Construct library technology`=="st-LFR technology"]="st-LFR technology (n=336)"
data_filter$`Construct library technology`[data_filter$`Construct library technology`=="Standard Next-Generation technology"]="Standard Next-Generation technology (n=6)"
data_filter$`Construct library technology`[data_filter$`Construct library technology`=="10X Genomics Linked reads"]="10X Genomics Linked reads (n=8)"

data_filter$`Construct library technology` = factor(data_filter$`Construct library technology`,levels=c("10X Genomics Linked reads (n=8)","Standard Next-Generation technology (n=6)","st-LFR technology (n=336)"))
...
ggsave("./assembly_20250911_all.pdf",w=6.2,h=5)
ggsave("./assembly_20250911_all.png",w=6.2,h=5)
...
ggsave("./assembly_20250911_all_v2.pdf",w=6.2,h=8)
ggsave("./assembly_20250911_all_v2.png",w=6.2,h=8)
...
ggsave("./assembly_20250911_all_v3.pdf",w=5.5,h=5.5)
ggsave("./assembly_20250911_all_v3.png",w=5.5,h=5.5)
...
ggplot(data_melted.busco, aes(x = `Scientific name`, y = value, fill = variable)) +
  ...
  coord_flip()
ggsave("./BUSCO_20250911_all.pdf",w=6.2,h=8)
ggsave("./BUSCO_20250911_all.png",w=6.2,h=8)
```
...
ggsave("./Annotation_20250911_newly_Danish.pdf",w=12.2,h=8)
ggsave("./Annotation_20250911_newly_Danish.png",w=12.2,h=8)
...
ggsave("./Annotation_20250911_newly_Danish_v3.pdf",w=8.5,h=8)
ggsave("./Annotation_20250911_newly_Danish_v3.png",w=8.5,h=8)
```
...
ggsave("./Annotation_20250911_all_Danish.pdf",w=12.2,h=8)
ggsave("./Annotation_20250911_all_Danish.png",w=12.2,h=8)
...
ggsave("./Annotation_20250911_all_Danish_v2.pdf",w=8.5,h=8)
ggsave("./Annotation_20250911_all_Danish_v2.png",w=8.5,h=8)
```
...
ggplot(data_melted.anno.te.taxo,aes(x=Order,group=Order,fill=Order))+
  ...
  labs(x="",y="",title="All")+
  coord_flip()
ggsave("./TE_annotation_20250911_all_Danish.pdf",w=6,h=8)
ggsave("./TE_annotation_20250911_all_Danish.png",w=6,h=8)
```
...
ggplot(data_melted.anno.te.taxo,aes(x=Order,group=Order,fill=Order))+
  ...
  labs(x="",y="",title="Newly")+
  coord_flip()
ggsave("./TE_annotation_20250911_newly_Danish.pdf",w=6,h=8)
ggsave("./TE_annotation_20250911_newly_Danish.png",w=6,h=8)
```
...
ggsave("./assembly_20250911_newly_Danish.pdf",w=5,h=5)
ggsave("./assembly_20250911_newly_Danish.png",w=5,h=5)
...
ggsave("./assembly_20250911_newly_Danish_v2.pdf",w=10,h=8)
ggsave("./assembly_20250911_newly_Danish_v2.png",w=10,h=8)
...
ggsave("./BUSCO_20250911_newly_Danish.pdf",w=6.2,h=8)
ggsave("./BUSCO_20250911_newly_Danish.png",w=6.2,h=8)
```
